...
cursor.execute("CREATE TABLE enote_task.ACCOUNT(id_account VARCHAR(20) PRIMARY KEY,id_person VARCHAR(20) FOREIGN KEY REFERENCES enote_task.CUSTOMERS(id_person),account_type VARCHAR(20))")
